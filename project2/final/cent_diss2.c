...
/**
 *@file centralized_dissemination.c
 */
...
int main(int argc, char** argv)
{
   ...
   printf("\nNumber of Processor Barriers: %d", numberOfProcessorBarriers);
    ...
    //Fork threads to perform the work and await their completion at dissemination Barrier
    ...
    centralizedMPI(argc, argv, numberOfProcessorBarriers);
}    
